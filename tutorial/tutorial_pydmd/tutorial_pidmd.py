...
plot_matrices(
    figsize=(6, 3),
    grid=(1, 4),
    matrices=[pidmd_ut.A, pidmd_lt.A, pidmd_ut_rank.A, pidmd_ut_rank.operator.as_numpy_array],
    titles=["Upper Triangular A", "Lower Triangular A", 'SVD rank A', 'SVD rank operator'],
)
